  ...
  const handleSubmitPress = () => {
    ...
    let dataToSend = {phone: userPhone, password: userPassword};
      ...
      .then((responseJson) => {
        ...
        //      AsyncStorage.setItem('id', responseJson.data[0].id);
        //  console.log(responseJson.data[0].user_id);
          navigation.replace('DrawerNavigationRoutes');
        //} else {
        //  setErrortext('Please check your phone number or password');
        //  console.log('Please check your phone number or password');
        //}
      })
      .catch((error) => {
        //Hide Loader
