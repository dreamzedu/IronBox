...
const RegisterScreen = (props) => {
  ...
  const [userPhone, setUserPhone] = useState('');
    ...
    const [userConfPassword, setUserConfirmPassword] = useState("");
          ...
          <View style={styles.SectionStyle}>
            ...
            <View style={styles.SectionStyle}>
                      <TextInput
                          ...
                          returnKeyType="next"
                          onSubmitEditing={() =>
                              confPasswordInputRef.current && confPasswordInputRef.current.focus()
                          }
                          blurOnSubmit={false}
                    />
                  </View>
                  <View style={styles.SectionStyle}>
                      <TextInput
                          style={styles.inputStyle}
                          onChangeText={(ConfPassword) => setUserConfirmPassword(ConfPassword)}
                          underlineColorAndroid="#f000"
